...
<body>
    ...
    <main>
        <div class="pemisah1">
            <h2 style="text-align: center; color: #824D69;"><strong>Hotel Booking</strong>
            </h2>
    ...
    <script>
        document.getElementById('cancelBookingButton').addEventListener('click', function() {
            ...
            form.method = 'POST';
            form.action = `/transaksi_room/${bookingId}`;
