            ...
            <div class="row mb-3">
                <div class="col-md-10 mx-auto">
                                ...
                                <div class="col-12 col-sm-8">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end align-items-end flex-column"
                                            ...
                                            <div class="d-flex">
                                                <form
                                                    action="{{ route('room_type.destroy', $roomType->id_room_type) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <a href="{{ route('room_type.edit', $roomType->id_room_type) }}"
                    ...
                    @else
                        <div class="mb-4">
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-secondary shadow button-tambah-kamar" style="background-color: grey;">
                                    <strong>+ Add Room</strong>
                                </button>
                            </div>
                        </div>
