                ...
                <div class="shadow p-4" style="max-width: 1000px; margin: auto;">
                    <div class="row mb-3">
                        <div class="col-md-10 mx-auto">
                            ...
                            <h2>Edit Admin</h2>
                            <hr>
                            <form method="POST" action="{{ route('Admin.users.updateAdmin', $admin->id_admin) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="text" id="admin_name" name="admin_name" class="form-control" 
                                            value="{{ old('admin_name', $admin->admin_name) }}" required>
                                    </div>
                                    @error('admin_name')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="email" id="admin_email" name="admin_email" class="form-control" 
                                            value="{{ old('admin_email', $admin->admin_email) }}" required>
                                    </div>
                                    @error('admin_email')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="password" id="admin_password" name="admin_password" class="form-control" 
                                            required minlength="8" value="{{ old('admin_password', $admin->admin_password) }}" required>
                                    </div>
                                ...
                                <div class="form-group mb-4">
                                    <label for="admin_telp" class="form-label"><strong>Phone Number</strong></label>
                                    <div class="input-group input-group-lg">
                                        <input type="text" id="admin_telp" name="admin_telp" class="form-control" 
                                            value="{{ old('admin_telp', $admin->admin_telp) }}" required>
                                    </div>
                                    @error('admin_telp')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="file" id="admin_picture" name="admin_picture" class="form-control" accept="image/*">
                                    </div>
                                    @error('admin_picture')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
